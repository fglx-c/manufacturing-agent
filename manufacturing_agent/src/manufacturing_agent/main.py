...
def run():
    ...
    inputs = {
        ...
        'control_options_path': '/scratch/ttc/manufacturing-agent/manufacturing_agent/src/data',
        'output_path': '/scratch/ttc/manufacturing-agent/manufacturing_agent/src/output'
    }
